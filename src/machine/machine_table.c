...
const machine_t machines[] = {
    ...
    { "[8088] Corona Data Systems PC400/PPC400",			"cpc400",		MACHINE_TYPE_8088,		CPU_PKG_8088, 0, 0, 0, 0, 0, 0, 0,										MACHINE_PC | MACHINE_VIDEO,				   128,    512,  64,    0,		      machine_xt_cpc400_init, NULL			},
