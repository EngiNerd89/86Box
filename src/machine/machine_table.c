...
const machine_t machines[] = {
    ...
    { "[VLSI 82C486] Olivetti M300-30/P",	"olivetti_m300_30",		MACHINE_TYPE_486,		CPU_PKG_SOCKET1, 0, 0, 0, 0, 0, 0, 0,                       MACHINE_AT | MACHINE_BUS_PS2 | MACHINE_IDE | MACHINE_VIDEO,						4096,   36864,   2048, 127,	  machine_at_olim300_30_init, NULL			},
